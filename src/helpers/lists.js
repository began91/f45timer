...
// function workoutStyle(name,category,numStations,numPods,numLaps,numSets,timing,misc) {
//     return {
//         name,
//         category,
//         numStations,
...
// const workoutStyleList = [
//     workoutStyle('3-Peat','H',10,1,3,1,timing('wr',45,15),'Score sheets with rep targets at each station. 2 Minute hydration break between laps'),
//     workoutStyle('22','C',18,3,1,2,timing('wr',45,15),'Combo station cardio blast. A-B-A-B format. Cardio version of Wingman'),
//     workoutStyle('Abacus','C',6,1,2,5,timing('wrwrwrwrwrwrwrwrwrwr',20,10,22,10,24,10,26,10,28,15,28,10,26,10,24,10,22,10,20,15),'N/A')
// ]
